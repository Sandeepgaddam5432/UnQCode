...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('unqcode_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('unqcode_profile', JSON.stringify(profileStore.get()));
  }
};
