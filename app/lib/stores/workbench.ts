...
export class WorkbenchStore {
  ...
  get unqcodeTerminal() {
    return this.#terminalStore.unqcodeTerminal;
  }
  get alert() {
  ...
  attachUnQCodeTerminal(terminal: ITerminal) {
    this.#terminalStore.attachUnQCodeTerminal(terminal);
  }
