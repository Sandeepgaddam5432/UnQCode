          ...
          <div className="space-y-1">
            <input
              ...
              className={classNames(
                ...
                'bg-unqcode-elements-background-depth-2 border border-unqcode-elements-borderColor',
                'text-unqcode-elements-textPrimary placeholder-unqcode-elements-textTertiary',
