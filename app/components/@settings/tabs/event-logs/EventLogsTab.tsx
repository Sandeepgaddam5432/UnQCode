...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with UnQCode
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('UnQCode - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by UnQCode', margin, doc.internal.pageSize.getHeight() - 10);
      ...
      // Save the PDF
      doc.save(`unqcode-event-logs-${new Date().toISOString()}.pdf`);
