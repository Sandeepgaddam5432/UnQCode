            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-bolt-elements-background dark:bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor hover:border-bolt-elements-borderColorActive/70 dark:hover:border-bolt-elements-borderColorActive/70 transition-all duration-200">
              ...
              <div
                className={classNames(
                  'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-unqcode-elements-textSecondary',
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-unqcode-elements-textPrimary dark:text-unqcode-elements-textPrimary"
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-unqcode-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-unqcode-elements-textPrimary dark:text-unqcode-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-unqcode-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  ...
                  {activeSiteIndex !== -1 && deploys.length > 0 && (
                    <div className="bg-unqcode-elements-background dark:bg-unqcode-elements-background-depth-1 border border-unqcode-elements-borderColor dark:border-unqcode-elements-borderColor rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-unqcode-elements-textPrimary dark:text-unqcode-elements-textPrimary">
                          <BuildingLibraryIcon className="h-4 w-4 text-unqcode-elements-item-contentAccent dark:text-unqcode-elements-item-contentAccent" />
                          Recent Deployments
                        </h4>
                      </div>
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-unqcode-elements-background dark:bg-unqcode-elements-background-depth-1 border border-unqcode-elements-borderColor dark:border-unqcode-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                                ...
                                >
                                  ...
                                  <span className="text-unqcode-elements-textPrimary dark:text-unqcode-elements-textPrimary">
                                    {deploy.state}
                                  </span>
                                </Badge>
                              </div>
                              <span className="text-xs text-unqcode-elements-textSecondary dark:text-unqcode-elements-textSecondary">
