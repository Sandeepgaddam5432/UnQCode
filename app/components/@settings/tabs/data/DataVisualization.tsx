...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const chartColors = {
    ...
    text: getThemeColor('--unqcode-elements-textPrimary'),
    textSecondary: getThemeColor('--unqcode-elements-textSecondary'),
    background: getThemeColor('--unqcode-elements-bg-depth-1'),
    accent: getThemeColor('--unqcode-elements-button-primary-text'),
    border: getThemeColor('--unqcode-elements-borderColor'),
  };
