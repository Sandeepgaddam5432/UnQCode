  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-unqcode-elements-borderColor bg-unqcode-elements-background-depth-1 text-unqcode-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-unqcode-elements-textSecondary', className)} {...props} />;
  },
);
