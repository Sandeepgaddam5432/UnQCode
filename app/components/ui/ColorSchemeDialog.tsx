...
export const ColorSchemeDialog: React.FC<ColorSchemeDialogProps> = ({ setDesignScheme, designScheme }) => {
  ...
  const renderTypographySection = () => (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-unqcode-elements-textPrimary flex items-center gap-2">
        <div className="w-2 h-2 rounded-full bg-unqcode-elements-item-contentAccent"></div>
        Typography
      </h3>
                  ...
                  f.key === 'border'
                    ...
                    : f.key === 'gradient'
                      ...
                      : isSelected
                        ...
                        : 'bg-unqcode-elements-bg-depth-3 hover:bg-unqcode-elements-bg-depth-2 text-unqcode-elements-textSecondary hover:text-unqcode-elements-textPrimary'
                } ${f.key === 'shadow' ? (isSelected ? 'shadow-xl' : 'shadow-lg') : 'shadow-md'}`}
                style={{
                  ...(f.key === 'gradient' && {
                    background: isSelected
                      ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'
                      : 'var(--unqcode-elements-bg-depth-3)',
                    color: isSelected ? 'white' : 'var(--unqcode-elements-textSecondary)',
                  }),
                }}
              >
                <div className="flex flex-col items-center gap-4">
                  <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-unqcode-elements-bg-depth-1 bg-opacity-20">
                    {f.key === 'rounded' && (
                      <div
    ...
    <div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  variant="ghost"
                  onClick={handleSave}
                  className="bg-unqcode-elements-button-primary-background hover:bg-unqcode-elements-button-primary-backgroundHover text-unqcode-elements-button-primary-text"
                >
                  Save Changes
                </Button>
              </div>
      ...
      <style>{`
        .custom-scrollbar {
          ...
          scrollbar-color: var(--unqcode-elements-textTertiary) transparent;
        }
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {
          background-color: var(--unqcode-elements-textTertiary);
          border-radius: 3px;
        }
        .custom-scrollbar::-webkit-scrollbar-thumb:hover {
          background-color: var(--unqcode-elements-textSecondary);
        }
        .line-clamp-2 {
          display: -webkit-box;
          -webkit-line-clamp: 2;
